export default {
    ...
    alert: {
      ...
      warning: 'bg-yellow-50 text-yellow-900 dark:bg-yellow-400 dark:text-white',
    ...
    badge: {
      ...
      primary: 'text-purple-700 bg-yellow-100 dark:text-white dark:bg-yellow-400',
    },
    // Backdrop
    backdrop: {
      base:
    ...
    button: {
      ...
      primary: {
        base: 'text-white bg-yellow-400 border border-transparent',
        active: 'active:bg-yellow-400 hover:bg-yellow-700 focus:ring focus:ring-purple-300',
      ...
      outline: {
        ...
        disabled: 'disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-300',
      },
      link: {
